        ...
        <div className="container12">
            ...
            <h3 className="recon"> Nomadic Stay</h3>
             ...
             <br /> <br /> 
                ...
                <label className="reg reg1">Address</label> <br />
                <input type="address" className="reg" /> <br />
                <label className="reg reg1">Phone Number</label> <br />
                <input type="tel" className="reg"/> <br /> <br />
